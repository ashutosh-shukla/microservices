        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="${pageContext.request.contextPath}/customers/withdraw/${customerId}" method="post">
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Maximum withdrawal limit: ₹50,000 per transaction</small>
                        </div>
